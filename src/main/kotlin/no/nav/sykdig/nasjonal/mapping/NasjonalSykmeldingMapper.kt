...
class NasjonalSykmeldingMapper(
    ...
    suspend fun createReceivedSykmelding(
        sykmeldingId: String,
        ...
        val pasient =
            personService.getPerson(id = smRegistreringManuell.pasientFnr, callId = callId)

        val tssId =
            sykmelderService.getTssIdInfotrygd(sykmelder.fnr!!, "", loggingMeta, sykmeldingId)
        ...
        return ReceivedSykmelding(
            ...
            mottattDato =
                oppgave.datoOpprettet?.toLocalDateTime()
                    ?: getLocalDateTime(msgHead.msgInfo.genDate),
