...
import no.nav.sykdig.felles.AnnenFraverGrunn
import no.nav.sykdig.felles.AnnenFraversArsak
...
import no.nav.sykdig.felles.Gradert
import no.nav.sykdig.felles.HarArbeidsgiver
import no.nav.sykdig.felles.KontaktMedPasient
import no.nav.sykdig.felles.MedisinskArsak
import no.nav.sykdig.felles.MedisinskArsakType
...
import no.nav.sykdig.felles.SvarRestriksjon
