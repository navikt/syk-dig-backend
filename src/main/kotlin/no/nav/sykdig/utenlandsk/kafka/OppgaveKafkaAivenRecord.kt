...
data class OppgaveKafkaAivenRecord(val hendelse: Hendelse, val oppgave: Oppgave)

@JsonIgnoreProperties(ignoreUnknown = true)
data class Oppgave(val oppgaveId: Long, val bruker: Bruker?, val kategorisering: Kategorisering)
