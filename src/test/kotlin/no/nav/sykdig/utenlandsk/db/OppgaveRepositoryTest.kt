...
class OppgaveRepositoryTest : IntegrationTest() {
    ...
    fun before() {
        oppgaveRepository.lagreOppgave(
            createDigitalseringsoppgaveDbModel(oppgaveId = "345", fnr = "sykmeldt-fnr")
        )
    }
    ...
    fun `should update oppgave`() {
        ...
        assertEquals(
            ...
            oppgave?.sykmelding?.sykmelding?.behandletTidspunkt,
        )
        assertEquals("ZMB", oppgave?.sykmelding?.utenlandskSykmelding?.land)
        assertEquals(
            "Z01",
            oppgave?.sykmelding?.sykmelding?.medisinskVurdering?.hovedDiagnose?.kode,
        )
        assertEquals(
            "ICPC2",
        ...
        assertEquals(
            "Z02",
            oppgave?.sykmelding?.sykmelding?.medisinskVurdering?.biDiagnoser?.get(0)?.kode,
        )
        assertEquals(
            "ICPC2",
        ...
        assertEquals(
            "Z03",
            oppgave?.sykmelding?.sykmelding?.medisinskVurdering?.biDiagnoser?.get(1)?.kode,
        )
        assertEquals(
            "ICPC2",
        ...
        assertEquals(
            ...
            oppgave?.sykmelding?.sykmelding?.perioder?.get(0)?.fom,
        )
        assertEquals(
            LocalDate.parse("2020-01-15"),
            oppgave?.sykmelding?.sykmelding?.perioder?.get(0)?.tom,
        )
        assertEquals(
            LocalDate.parse("2021-01-01"),
            oppgave?.sykmelding?.sykmelding?.perioder?.get(1)?.fom,
        )
        assertEquals(
            LocalDate.parse("2021-01-15"),
            oppgave?.sykmelding?.sykmelding?.perioder?.get(1)?.tom,
        )
